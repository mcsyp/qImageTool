#ifndef COMBINE3DIMAGEYUV_H
#define COMBINE3DIMAGEYUV_H

#include "combine3dimageNV12.h"
#include "combine3dimagebgrx.h"
#include "r3d_colorconvert.h"

class Combine3DImageYUV : public Combine3DImageNV12
{
public:
    explicit Combine3DImageYUV(QObject *parent = 0);
...
protected:
    ...
    virtual FMT_3D_COMBINE formatType(){return FMT_3D_YUV;}
protected:
    R3D_BGRXtoYCbCr m_rgbToYuv;
    Combine3DImageBGRX m_combBgrx;
};

#endif // COMBINE3DIMAGEYUV_H
